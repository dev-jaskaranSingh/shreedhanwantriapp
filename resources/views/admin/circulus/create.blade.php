...
<div class="row">
    <div class="alert alert-info" role="alert">
        <b>NOTE: </b>Previous circulus will be overwritten.
    </div>
    <div class="col-sm-10 col-sm-offset-2">
        <h1>Update Circulus</h1>
...
{!! Form::open(array('files' => true, 'route' => config('coreadmin.route').'.circulus.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
